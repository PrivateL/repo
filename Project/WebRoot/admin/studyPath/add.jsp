...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/studyPath_save.action" method="post" enctype="multipart/form-data"
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="text" name="pathName"  id="pathName" class="bg"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea name="pathDesc" cols="30" rows="3" id="pathDesc" style="WIDTH: 96%"></textarea>
					</td>
				</tr>
				<tr>
